 ...
 * 
 * @param {string} period
 * The period (daily, weekly, monthly) for which the trending repos should be fetched.
 * If nothing is specify, daily trending repos will be fetched.
 *
 ...
 * 
 */
function trending (language, period, callback) {
    ...
    request(endpoint, {l: language, since: period}, onResponse);
}
